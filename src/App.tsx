...
function App() {
   ...
   // Convierte la clave VAPID para el navegador
   ...
   const activarNotificaciones = async () => {
      // 1. Verificamos que el navegador soporte Push (Safari en iOS 16.4+ lo hace)
      ...
      try {
         // 2. Le pedimos permiso al usuario (acá sale el cartelito nativo)
         const permission = await Notification.requestPermission();
         if (permission !== 'granted') {
            alert('Permiso denegado. No podremos avisarte de fallas térmicas.');
            return;
         }

         // 3. Registramos el archivo sw.js que creaste recién
         const register = await navigator.serviceWorker.register('/sw.js');
         console.log('Service Worker registrado correctamente.');

         // 4. Creamos la suscripción usando tu CLAVE PÚBLICA (pegala acá, es seguro que sea pública)
         ...
         // 5. Enviamos el token a nuestro backend de Railway
         // NOTA: Reemplazá el ID por el de tu sucursal "Al Fuego Dalvian" o sacalo de tu estado de React
         const branchIdActual = "6aa967d7b062e946de93aa1b";

         await fetch('https://termosync-backend-production.up.railway.app/api/subscribe', {
            method: 'POST',
            body: JSON.stringify({
               subscription,
               branchId: branchIdActual
            }),
            headers: {
         ...
         alert('¡Suscripción exitosa! Ahora recibirás alertas térmicas en este dispositivo.');
                     ...
                     <div className="relative z-10 space-y-8">
                        <div className="flex flex-wrap items-center gap-3">
                           ...
                           <button
                              ...
                              className="bg-blue-600 text-white px-4 py-2 rounded-lg mt-4 shadow"
                           >
